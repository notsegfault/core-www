...
export class Yam {
  constructor(provider, networkId, testing, options) {
    ...
    this.contracts.setProvider(realProvider, networkId);
    this.contracts.setContractsProvider(realProvider, networkId);
    this.contracts.setDefaultAccount(this.web3.eth.defaultAccount);
