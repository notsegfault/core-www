...
export class Account {
  ...
  async getUNIAmplWalletBalance() {
    this.walletInfo['UNIAmpl'] = await this.contracts.UNIAmpl.methods
      .balanceOf(this.accountInfo)
      .call();
    return this.walletInfo['UNIAmpl'];
  }

  async getUNIUSDTWalletBalance() {
    this.walletInfo['UNIUSDT'] = await this.contracts.UNIUSDT.methods
      .balanceOf(this.accountInfo)
      .call();
    return this.walletInfo['UNIUSDT'];
  }
