...
import { useCoreBalance, useFannyInfo, useUserStakedInPool, useUserTokenBalance } from '../../hooks';
...
const WithdrawOrStakeInputDialog = ({ setTransactionValue, type, tokenName, pid, lockTimeWeeks, setLockTimeWeeks }) => {
    ...
    switch (lockTimeWeeks) {
      ...
      case 'burn':
        return <div style={{ display: 'flex' }}>
          ...
          <span style={{ margin: 'auto' }}>Your CORE will be burnt but you<br />will benefit from the maximum multiplier.</span>
        </div>
      default:
  ...
  const renderFannyStakingLockTimeMultipliers = () => {
    return <div style={{ marginTop: '1em' }}>
      <div><strong>Choose your reward multiplier</strong></div>
      <div>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      >
        ...
        <Button
          ...
          onClick={() => BigNumber.isBigNumber(value) && setTextFieldValue(value.div(new BigNumber(10).pow(18)))}
        >
          MAX
        </Button>
      </div>
